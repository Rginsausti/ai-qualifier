...
export default function Dashboard() {
  ...
  useEffect(() => { refreshFormRef.current?.requestSubmit() }, [])
  useEffect(() => { if (qualifyState.score !== null) refreshFormRef.current?.requestSubmit() }, [qualifyState.score])
  ...
  return (
    <main className="dash">
      ...
      <div className="dash__wrap">
        ...
        <div className="auth__card dash__header">
          <div className="dash__brand">
            <Image src="/ai-rgi-qualifier.png" alt="AI-RGI-QUALIFIER" width={28} height={28} className="dash__logo" />
            <h1 className="auth__title dash__title">Dashboard</h1>
          </div>
          <form action={signOut}>
